                    ...
                    <div class="interaction__comments-wrapper svg-leveling">
                        <span class="interaction__comments-button">
                            <svg width="21" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0.5 1.5C0.5 0.947715 0.947715 0.5 1.5 0.5H18.5C19.0523 0.5 19.5 0.947715 19.5 1.5V14.5C19.5 15.0523 19.0523 15.5 18.5 15.5H11.5L6.5 19.5V15.5H1.5C0.947715 15.5 0.5 15.0523 0.5 14.5V1.5Z"/>
                            </svg>
                        </span>
